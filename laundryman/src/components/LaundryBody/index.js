    ...
    render(){
        return(
            <div className="background-2">
                <h1 className="back2-head">Why To Choose <span className='span2'>Laundry Shop</span>?</h1>
                <p className="tagline">Lorem ipsum dolor sit amet, consectetur adipiscing elit</p>
                 
                <div className="features">
                    {fearturesOfback2.map(each=><FeatureBox each={each} key={each.con1}/>)}
                </div>
                <div className="dots">
                ...
                {iphones.map(eachi=><Iphonecon key={eachi.iurl} eachi={eachi} />)}
                <Iphone3/>
                <Alliphones/>
                <Lastsetion/>
            </div>
