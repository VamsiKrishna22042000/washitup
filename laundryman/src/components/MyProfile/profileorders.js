  ...
  const ModalBoxItems = () => {
    ...
    return (
      <>
        ...
        ></div>
        <div style={{ zIndex: 20 }} className="modal1">
          <div className="items-modalbox-con1">
            {!showDate && (
              <button
                onClick={() => {
                  setShowSupport(true);
    ...
    return (
      <>
        ...
        <div className="modal1">
          ...
          {load ? (
            <>
              <div style={{ zIndex: "20" }} className="support-modalbox-con1">
                {issues.length === 0 ? (
                  <div>
